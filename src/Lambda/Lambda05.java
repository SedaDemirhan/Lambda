...
public class Lambda05 {
    public static void main(String[] args) {
        ...
        IntStream.rangeClosed(1,20).forEach(metodLambda2::bosluklaYzdir);
...
//7)  11 den 33 e kadar her tam sayının rakamlarının toplamını hesaplamak için bir metod oluşturun
   ...
   IntStream.rangeClosed(11,33).map(metodLambda2::rakamlarToplami).forEach(metodLambda2::bosluklaYzdir);
