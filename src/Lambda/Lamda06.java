...
public class Lamda06 {
    public static void main(String[] args) {
        UniversiteLambda06 edebiyatBolüm=new UniversiteLambda06("fen edebiyat","edebiyat",97,128);
        ...
        List<UniversiteLambda06>uniList=new ArrayList<>(Arrays.asList(edebiyatBolüm,iktisatBolum,matematikBolum,ingilizceBolum));
...
//2)Ders adlarından en az birinin "Matem" kelimesini içerip içermediğini kontrol etmek için bir yöntem oluşturun
        System.out.println(uniList.stream().anyMatch(t -> t.getBolüm().contains("Matem")));
